...
public class Update_Input_userinfo extends Shell {
	private Text f_name;
	...
	public static void main(String args[]) {
		try {
			...
			Update_Input_userinfo shell = new Update_Input_userinfo(display);
			shell.open();
			shell.layout();
	 ...
	 * @param display
	 */
	public Update_Input_userinfo(Display display) {
